...
export default function AncestryAnalysisPage() {
  ...
  const [ancestryData, setAncestryData] =
    useState<AncestryData>(emptyAncestryData)
                ...
                <div className="mt-6 relative">
                  ...
                  {isLoading ? (
                    ...
                    <div className="space-y-2 relative">
                      <div
                        className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-white via-white/90 to-transparent pointer-events-none transition-opacity duration-300"
                        style={{ opacity: isExpanded ? 0 : 1 }}
                      />

                      <div
                        className="max-h-[200px] overflow-y-auto transition-all duration-300"
                          ...
                          .map((item, index) => (
                            ...
                            >
                              ...
                              <span className="relative z-10 text-gray-600">
                                {regionNames[language][
                                  item.region as keyof (typeof regionNames)["en"]
                                ] || item.region}
                              </span>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  {String(t("understandingResults"))}
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  {String(t("compositionDescription"))}
                </p>
                ...
                <div className="pt-2">
                  <h3 className="text-sm font-medium mb-1">
                    {String(t("admixtureTechnology"))}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {String(t("admixtureTechDescription"))}
                  </p>
                </div>
                ...
                <div className="pt-2">
                  <h3 className="text-sm font-medium mb-1">
                    {String(t("haplogroupsExplained"))}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {String(t("haplogroupsExplainedDescription"))}
                  </p>
                </div>
              </CardContent>
            </Card>
